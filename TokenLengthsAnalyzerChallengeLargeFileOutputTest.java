...
/** This unit test is for the histogram extra challenge using a large file so that the value of a star is
 * a fraction*/
public class TokenLengthsAnalyzerChallengeLargeFileOutputTest {
   ...
   @AfterClass
    ...
    public void testHistogramLineFiveTokenLength() {
        assertTrue(outputFileContents.get(4).startsWith("21"));
    }
    ...
    public void testHistogramLineFiveStars() {
        double count = TestUtilities.countStars(outputFileContents.get(4));
